...
def put_text(image, text, coord, color = (0,255,0), font_size = 0.5, font_thickness = 1):  
    font = cv2.FONT_HERSHEY_SIMPLEX #Creates a font
    x = coord[0]
    y = coord[1]
    cv2.putText(image, text, (x,y), font, font_size, color, font_thickness) #Draw the text
