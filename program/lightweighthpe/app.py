...
def run(net, image_provider, height_size, cpu, track, smooth):
    ...
    for img in image_provider:
        ...
        cv2.putText(img, '%.2fms' %  ((ts2 - ts1) * 1000.0), (10, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255))
...
def run_lightweight(net, img, height_size = 256, cpu = False, track = False, smooth = True):
    ts1 = time.time()
