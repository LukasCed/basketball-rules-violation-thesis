...
stats = assert_equals((True, 0), proccess_turnover_test('vids/videos/2_travel_1.mp4'), stats)
stats = assert_equals((True, 0), proccess_turnover_test('vids/videos/2_travel_2.mp4'), stats)
stats = assert_equals((True, 0), proccess_turnover_test('vids/videos/2_travel_3.mp4'), stats)
stats = assert_equals((True, 0), proccess_turnover_test('vids/videos/2_travel_4.mp4'), stats)
stats = assert_equals((True, 0), proccess_turnover_test('vids/videos/2_travel_5.mp4'), stats)
stats = assert_equals((True, 0), proccess_turnover_test('vids/videos/2_travel_6.mp4'), stats)
stats = assert_equals((True, 0), proccess_turnover_test('vids/videos/2_travel_7.mp4'), stats)
stats = assert_equals((True, 0), proccess_turnover_test('vids/videos/2_travel_8.mp4'), stats)
stats = assert_equals((True, 0), proccess_turnover_test('vids/videos/2_travel_9.mp4'), stats)
stats = assert_equals((True, 0), proccess_turnover_test('vids/videos/2_travel_10.mp4'), stats)
stats = assert_equals((True, 0), proccess_turnover_test('vids/videos/2_travel_11.mp4'), stats)
...
stats = assert_equals((True, 1), proccess_turnover_test('vids/videos/2_double_dribble_1.mp4'), stats)
stats = assert_equals((True, 1), proccess_turnover_test('vids/videos/2_double_dribble_2.mp4'), stats)
stats = assert_equals((True, 1), proccess_turnover_test('vids/videos/2_double_dribble_3.mp4'), stats)
stats = assert_equals((True, 1), proccess_turnover_test('vids/videos/2_double_dribble_4.mp4'), stats)
stats = assert_equals((True, 1), proccess_turnover_test('vids/videos/2_double_dribble_5.mp4'), stats)
stats = assert_equals((True, 1), proccess_turnover_test('vids/videos/2_double_dribble_6.mp4'), stats)
stats = assert_equals((True, 1), proccess_turnover_test('vids/videos/2_double_dribble_7.mp4'), stats)
stats = assert_equals((True, 1), proccess_turnover_test('vids/videos/2_double_dribble_8.mp4'), stats)
stats = assert_equals((True, 1), proccess_turnover_test('vids/videos/2_double_dribble_9.mp4'), stats)
stats = assert_equals((True, 1), proccess_turnover_test('vids/videos/2_double_dribble_10.mp4'), stats)
stats = assert_equals((True, 1), proccess_turnover_test('vids/videos/2_double_dribble_11.mp4'), stats)
stats = assert_equals((True, 1), proccess_turnover_test('vids/videos/2_double_dribble_12.mp4'), stats)

stats = assert_equals((False, 1), proccess_turnover_test('vids/videos/2_dribble_1.mp4'), stats)
stats = assert_equals((False, 1), proccess_turnover_test('vids/videos/2_dribble_2.mp4'), stats)
stats = assert_equals((False, 1), proccess_turnover_test('vids/videos/2_dribble_3.mp4'), stats)
stats = assert_equals((False, 1), proccess_turnover_test('vids/videos/2_dribble_4.mp4'), stats)
stats = assert_equals((False, 1), proccess_turnover_test('vids/videos/2_dribble_5.mp4'), stats)
stats = assert_equals((False, 1), proccess_turnover_test('vids/videos/2_dribble_6.mp4'), stats)
stats = assert_equals((False, 1), proccess_turnover_test('vids/videos/2_dribble_7.mp4'), stats)
stats = assert_equals((False, 1), proccess_turnover_test('vids/videos/2_dribble_8.mp4'), stats)
stats = assert_equals((False, 1), proccess_turnover_test('vids/videos/2_dribble_9.mp4'), stats)
stats = assert_equals((False, 1), proccess_turnover_test('vids/videos/2_dribble_10.mp4'), stats)
